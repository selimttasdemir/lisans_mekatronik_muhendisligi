...
for i=1:num
    ...
    F(i,3)=answer1(3,1);
    F(i,4)=answer1(4,1);
    C=simplify([cos(F(i,4)) -sin(F(i,4)) 0 F(i,1);
             sin(F(i,4))*cos(F(i,2)) cos(F(i,4))*cos(F(i,2)) -sin(F(i,2)) -sin(F(i,2))*F(i,3);
             sin(F(i,4))*sin(F(i,2)) cos(F(i,4))*sin(F(i,2)) cos(F(i,2)) cos(F(i,2))*F(i,3);
             0 0 0 1]);
