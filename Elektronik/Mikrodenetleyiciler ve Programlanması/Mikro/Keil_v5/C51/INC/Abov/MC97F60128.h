...
//------------------------------------------------------
// Timer 0/1/2
sfr			T0CRT		= 0xD2;			// R/W, Timer 0 Control Register
sfr			T0CNTT		= 0xD3;			// R,   Timer 0 Counter Register
sfr			T0DRT		= 0xD4;			// R/W, Timer 0 Data Register
sfr			T0CDRT		= 0xD4;			// R,   Timer 0 Capture Data Register

sfr			T1CRT		= 0xDA;			// R/W, Timer 1 Control Register
sfr			T1CNTT		= 0xDB;			// R,   Timer 1 Counter Register
sfr			T1DRT		= 0xDC;			// R/W, Timer 1 Data Register
sfr			T1CDRT		= 0xDC;			// R,   Timer 1 Capture Data Register


sfr			T2CRT		= 0xDD;			// R/W, Timer 2 Control Register
sfr			T2CNTT		= 0xDE;			// R,   Timer 2 Counter Register
sfr			T2DRT		= 0xDF;			// R/W, Timer 2 Data Register
sfr			T2CDRT		= 0xDF;			// R,   Timer 2 Capture Data Register
